...
public class ProcessorTests
{
    ...
    {
        var tokens = Parser.Parse("1 2 3").Value;
        var result = _processor.Process(tokens);
    ...
    {
        var tokens = Parser.Parse("1 +").Value;
        var result = _processor.Process(tokens);
        Assert.False(result.IsSuccessful);
    ...
    {
        _processor.Process(Parser.Parse("5 3 +").Value);
    ...
    {
        var tokens = Parser.Parse("1 2 +").Value;
        var result = _processor.Process(tokens);
        Assert.True(result.IsSuccessful);
    ...
    {
        var tokens = Parser.Parse("2 3 +").Value;
        var result = _processor.Process(tokens);
        Assert.True(result.IsSuccessful);
    ...
    {
        var tokens = Parser.Parse("5 3 - 2 *").Value;
        var result = _processor.Process(tokens);
        Assert.True(result.IsSuccessful);
    ...
    {
        var tokens = Parser.Parse("5 0 /").Value;
        var result = _processor.Process(tokens);
        Assert.False(result.IsSuccessful);
    ...
    {
        _processor.Process(Parser.Parse("1 2").Value);
        Assert.Equal(2, _processor.Stack.Count);

        var result = _processor.Process(Parser.Parse("+").Value);
        Assert.True(result.IsSuccessful);
    ...
    {
        _processor.Process(Parser.Parse("1 2 3").Value);
        Assert.Equal(3, _processor.Stack.Count);
        var result = _processor.Process(Parser.Parse("clear()").Value);
        Assert.True(result.IsSuccessful);
    ...
    public void Process_PopCommand_ShouldPopLastElementFromStack()
    {
        _processor.Process(Parser.Parse("1 2 3").Value);
        Assert.Equal(3, _processor.Stack.Count);
        var result = _processor.Process(Parser.Parse("pop()").Value);
        Assert.True(result.IsSuccessful);
        Assert.Equal(2, _processor.Stack.Count);
        Assert.Equal(3, result.Value);
    ...
    public void Process_SwapCommand_ShouldSwapLastTwoNumbersOfStack()
    {
        _processor.Process(Parser.Parse("1 2 3").Value);
        Assert.Equal(3, _processor.Stack.Count);
        var result = _processor.Process(Parser.Parse("swap()").Value);
        Assert.True(result.IsSuccessful);
        Assert.Equal(3, _processor.Stack.Count);
    ...
    public void Process_SumCommand_ShouldClearStackAndPushSum()
    {
        _processor.Process(Parser.Parse("1 2 3").Value);
        Assert.Equal(3, _processor.Stack.Count);
        var result = _processor.Process(Parser.Parse("sum()").Value);
        Assert.True(result.IsSuccessful);
        Assert.Equal(1, _processor.Stack.Count);
    ...
    {
        _processor.Process(Parser.Parse("4").Value);
        Assert.Equal(1, _processor.Stack.Count);
        Assert.Equal(4, _processor.Stack.Peek().Value);
        var result = _processor.Process(Parser.Parse("sqrt()").Value);
        Assert.True(result.IsSuccessful);
    ...
    {
        _processor.Process(Parser.Parse("-1").Value);
        Assert.Equal(1, _processor.Stack.Count);
    ...
    {
        _processor.Process(Parser.Parse("2 3").Value);
        Assert.Equal(2, _processor.Stack.Count);
        Assert.Equal(2, _processor.Stack.ToArray()[0]);
        Assert.Equal(3, _processor.Stack.ToArray()[1]);
        var result = _processor.Process(Parser.Parse("pow()").Value);
        Assert.True(result.IsSuccessful);
    ...
    public void Process_ReciprocalCommand_ShouldCalculateReciprocalOfLastElementAndPushResult()
    {
        ...
        Assert.Equal(1, _processor.Stack.Count);
        Assert.Equal(4, _processor.Stack.Peek().Value);
        var result = _processor.Process(Parser.Parse("reciprocal()").Value);
        Assert.True(result.IsSuccessful);
